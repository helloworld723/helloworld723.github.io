...
<br />
&emsp;&emsp;如果你依然搭建过几次GitHub Pages，可以直接跳过第二部分，听我的，节省时间。
<br />
...
廖大牛在他官方网站将到的 git remote add origin git@github.com:michaelliao/learngit.git 这个命令。只不过我们是
“直捣黄龙”。
<br />
...
![_config.yml中的links及空格提醒.png]({{site.baseurl}}/assets/img/image/_config.yml中的links及空格提醒.png)
...
![_config.yml中的username.png]({{site.baseurl}}/assets/img/image/_config.yml中的username.png)
...
![_post内容.png]({{site.baseurl}}/assets/img/image/_post内容.png)
...
> ![引用文章配图.png]({{site.baseurl}}/assets/img/image/引用文章配图.png)
> 
> 使用jekyll写博文
...
<br />
&emsp;&emsp;当年我看阮一峰前辈的博客的时候，在底下发现了一条评论，其观点很是让我震惊，但不好意思，我还是要站在他的对立面，因为为信仰共享与自由。
